...
#include "../Repaint/mytoolbutton.h"
...
void MyToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyToolButton::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyToolButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_MyToolButton.data,
      qt_meta_data_MyToolButton,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void MyToolButton::doubleClicked()
{
